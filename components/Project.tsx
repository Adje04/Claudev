    ...
    >
      ...
      >
        <div className='relative w-full h-[230px]'>
          <Image
            src={image}
            alt={workT(name as keyof typeof workT)}
            width={320}
            height={320}
        ...
        <h3 className='text-white font-bold text-[24px]'>{workT(name as keyof typeof workT)}</h3>
         {website_link &&
           ...
           <p className='mt-2 text-secondary text-[14px]'>{workT (description as keyof typeof workT)}</p>
        </div>
