...
const ProjectCard = ({
  ...
  const workT = useScopedI18n('projects');
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        <h3 className='text-white font-bold text-[24px]'>{workT(name)}</h3>
         {website_link &&
           ...
           <p className='mt-2 text-secondary text-[14px]'>{workT (description)}</p>
        </div>
  ...
  return (
    <section className="padding-container max-container mt-[2.5rem]" id='projects'>
      <div>
        ...
        >
          <p className="section-sub-text">{workT('title')}</p>
          <h2 className="section-head-text">{workT('project')}.</h2>
        </motion.div>
...
//           transition={{ duration: 0.6 }}
//         >
//           <p className="section-sub-text">{t('title')}</p>
//           <h2 className="section-head-text">{t('project')}.</h2>
//         </motion.div>
